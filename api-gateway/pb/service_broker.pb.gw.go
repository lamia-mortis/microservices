...
func request_Broker_RegisterUser_0(ctx context.Context, marshaler runtime.Marshaler, client BrokerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Broker_RegisterUser_0(ctx context.Context, marshaler runtime.Marshaler, server BrokerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RegisterUserRequest
	var metadata runtime.ServerMetadata
...
func RegisterBrokerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BrokerServer) error {
	...
	mux.Handle("POST", pattern_Broker_RegisterUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.Broker/RegisterUser", runtime.WithHTTPPathPattern("/v1/register_user"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Broker_RegisterUser_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Broker_RegisterUser_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBrokerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BrokerClient) error {
	...
	mux.Handle("POST", pattern_Broker_RegisterUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.Broker/RegisterUser", runtime.WithHTTPPathPattern("/v1/register_user"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Broker_RegisterUser_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Broker_RegisterUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "register_user"}, ""))
)

var (
	forward_Broker_RegisterUser_0 = runtime.ForwardResponseMessage
)
